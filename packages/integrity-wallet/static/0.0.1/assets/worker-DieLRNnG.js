...
const $init = (async () => {
  const module0 = fetchCompile(new URL("https://peerpiper.github.io/peerpiper/0.0.1/assets/js-component-bindgen-component.core-DyO5Xpr-.wasm", import.meta.url));
  const module1 = fetchCompile(new URL("https://peerpiper.github.io/peerpiper/0.0.1/assets/js-component-bindgen-component.core2-acliwOvP.wasm", import.meta.url));
...
async function Vn(e4) {
  if (void 0 !== An)
    return An;
  void 0 === e4 && (e4 = new URL("https://peerpiper.github.io/peerpiper/0.0.1/assets/bindings_wasm_bg-D_w-mH2m.wasm", import.meta.url));
  const t2 = zn();
...
const shimSourceURL = new URL("https://peerpiper.github.io/peerpiper/0.0.1/assets/_preview2-shim-DNYff_t_.js", import.meta.url);
  ...
  switch (action) {
    case "load":
      try {
        ...
        if ((payload == null ? void 0 : payload.templates) && payload.templates.length > 0) {
