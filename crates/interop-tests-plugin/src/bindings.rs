        ...
        pub mod commands {
            ...
            pub fn order(order: &AllCommands) -> Pollable {
                unsafe {
                    ...
                    Pollable::from_handle(ret as u32)
                }
            }
            impl Pollable {
                #[allow(unused_unsafe, clippy::all)]
            ...
            pub mod run {
                ...
                impl Plugin {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = _rt::Box::from_raw(handle as *mut _PluginRep<T>);
                    }
                ...
                pub unsafe fn _export_method_plugin_run_tests_cabi<T: GuestPlugin>(
                    ...
                    let result0 = T::run_tests(
                        PluginBorrow::lift(arg0 as u32 as usize).get(),
                    );
                ...
                macro_rules! __export_component_plugin_run_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        export_constructor_plugin() -> i32 { $($path_to_types)*::
                        _export_constructor_plugin_cabi::<<$ty as $($path_to_types)*::
                        Guest >::Plugin > () } #[export_name =
                        "component:plugin/run#[method]plugin.run-tests"] unsafe extern
                        "C" fn export_method_plugin_run_tests(arg0 : * mut u8,) -> * mut
                        u8 { $($path_to_types)*::
                        _export_method_plugin_run_tests_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Plugin > (arg0) } #[export_name =
                        "cabi_post_component:plugin/run#[method]plugin.run-tests"] unsafe
                        extern "C" fn _post_return_method_plugin_run_tests(arg0 : * mut
                        u8,) { $($path_to_types)*::
                        __post_return_method_plugin_run_tests::<<$ty as
                        $($path_to_types)*:: Guest >::Plugin > (arg0) } #[export_name =
                        "component:plugin/run#[method]plugin.put-record"] unsafe extern
                        "C" fn export_method_plugin_put_record(arg0 : * mut u8, arg1 : *
                        mut u8, arg2 : usize, arg3 : * mut u8, arg4 : usize,) {
                        $($path_to_types)*:: _export_method_plugin_put_record_cabi::<<$ty
                        as $($path_to_types)*:: Guest >::Plugin > (arg0, arg1, arg2,
                        ...
                        #[export_name = "component:plugin/run#[method]plugin.tick"]
                        unsafe extern "C" fn export_method_plugin_tick(arg0 : * mut u8,)
                        -> * mut u8 { $($path_to_types)*::
                        _export_method_plugin_tick_cabi::<<$ty as $($path_to_types)*::
                        Guest >::Plugin > (arg0) } #[export_name =
                        "cabi_post_component:plugin/run#[method]plugin.tick"] unsafe
                        extern "C" fn _post_return_method_plugin_tick(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_method_plugin_tick::<<$ty as
                        $($path_to_types)*:: Guest >::Plugin > (arg0) } #[export_name =
                        ...
                        arg1, arg2, arg3, arg4, arg5) } #[export_name =
                        "cabi_post_component:plugin/run#handle-message"] unsafe extern
                        "C" fn _post_return_handle_message(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_handle_message::<$ty > (arg0)
                        } #[export_name = "component:plugin/run#handle-request"] unsafe
                        ...
                        "C" fn _post_return_handle_request(arg0 : * mut u8,) {
                        ...
                        Plugin::dtor::< <$ty as $($path_to_types)*:: Guest >::Plugin >
                        (rep) } }; };
                    };
                }
                #[doc(hidden)]
