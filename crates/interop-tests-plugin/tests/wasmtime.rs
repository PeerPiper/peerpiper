...
//
// //use crate::bindgen::exports::component::plugin::handlers;
//
//struct MyCtx {
//    table: ResourceTable,
//    ctx: WasiCtx,
...
//
//impl bindgen::component::plugin::peer_piper_commands::Host for MyCtx {
...
//
//    // From<bindgen::component::plugin::types::Error>
//    #[error("Error: {0}")]
...
mod test_mod_echo {
    ...
    use super::*;
    //use bindgen::host::component::types::Message;
