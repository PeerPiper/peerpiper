      ...
      pub mod wurbo_out {
        ...
        const _: () = {
          ...
          unsafe extern "C" fn __export_render(arg0: i32,) -> i32 {
            ...
            use super::super::super::super::peerpiper::wallet::context_types::Context as V120;
            let v120 = match l0 {
              0 => {
                let e120 = {
              ...
              n => {
                debug_assert_eq!(n, 4, "invalid enum discriminant");
                let e120 = {
                  let l117 = *((arg0 + 4) as *const i32);
                  let l118 = *((arg0 + 8) as *const i32);
