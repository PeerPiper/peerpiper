      ...
      pub mod wurbo_out {
        ...
        const _: () = {
          ...
          unsafe extern "C" fn __export_render(arg0: i32,) -> i32 {
            ...
            use super::super::super::super::peerpiper::wallet::context_types::Context as V129;
            let v129 = match l0 {
              0 => {
                let e129 = {
              ...
              3 => {
                let e129 = {
                  ...
                  use super::super::super::super::peerpiper::wallet::context_types::Events as V125;
                  let v125 = match l112 {
                    0 => {
                      let e125 = {
              ...
              n => {
                debug_assert_eq!(n, 4, "invalid enum discriminant");
                let e129 = {
                  let l126 = *((arg0 + 4) as *const i32);
                  let l127 = *((arg0 + 8) as *const i32);
                  let len128 = l127 as usize;
                  let bytes128 = Vec::from_raw_parts(l126 as *mut _, len128, len128);
                  
                  wit_bindgen::rt::string_lift(bytes128)
                };
                V129::Message(e129)
              }
            };
            let result130 = <_GuestImpl as Guest>::render(v129);
            wit_bindgen::rt::dealloc(arg0, 108, 4);
            let ptr131 = _RET_AREA.0.as_mut_ptr() as i32;
            match result130 {
              Ok(e) => { {
                *((ptr131 + 0) as *mut u8) = (0i32) as u8;
                ...
                *((ptr131 + 8) as *mut i32) = len132;
                *((ptr131 + 4) as *mut i32) = ptr132;
              } },
              Err(e) => { {
                *((ptr131 + 0) as *mut u8) = (1i32) as u8;
                ...
                *((ptr131 + 8) as *mut i32) = len133;
                *((ptr131 + 4) as *mut i32) = ptr133;
              } },
            };ptr131
          }
