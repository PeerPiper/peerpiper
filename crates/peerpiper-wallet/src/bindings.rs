        ...
        pub mod wallet {
            ...
            pub mod wurbo_out {
                ...
                macro_rules! __export_peerpiper_wallet_wurbo_out_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "peerpiper:wallet/wurbo-out@0.1.0#customize"] unsafe extern "C"
                        fn export_customize(arg0 : * mut u8, arg1 : usize,) -> * mut u8 {
                        $($path_to_types)*:: _export_customize_cabi::<$ty > (arg0, arg1)
                        } #[export_name =
                        "cabi_post_peerpiper:wallet/wurbo-out@0.1.0#customize"] unsafe
                        extern "C" fn _post_return_customize(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_customize::<$ty > (arg0) }
                        #[export_name = "peerpiper:wallet/wurbo-out@0.1.0#render"] unsafe
                        extern "C" fn export_render(arg0 : * mut u8,) -> * mut u8 {
                        $($path_to_types)*:: _export_render_cabi::<$ty > (arg0) }
                        #[export_name =
                        "cabi_post_peerpiper:wallet/wurbo-out@0.1.0#render"] unsafe
            ...
            pub mod aggregation {
                ...
                macro_rules! __export_peerpiper_wallet_aggregation_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "peerpiper:wallet/aggregation@0.1.0#activates"] unsafe extern "C"
                        fn export_activates(arg0 : i32, arg1 : * mut u8, arg2 : usize,) {
                        $($path_to_types)*:: _export_activates_cabi::<$ty > (arg0, arg1,
                        arg2) } };
                    };
                }
                #[doc(hidden)]
...
macro_rules! __export_peerpiper_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::peerpiper::wallet::wurbo_out::__export_peerpiper_wallet_wurbo_out_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::peerpiper::wallet::wurbo_out);
        $($path_to_types_root)*::
        exports::peerpiper::wallet::aggregation::__export_peerpiper_wallet_aggregation_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::peerpiper::wallet::aggregation);
    };
}
#[doc(inline)]
pub(crate) use __export_peerpiper_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:peerpiper:wallet@0.1.0:peerpiper:encoded world"]
#[doc(hidden)]
...
d\x01\x01\0\x06submit\0\0\x04\0\x07context\x03\0\x0d\x03\0$seed-keeper:wit-ui/wu\
rbo-types@0.1.0\x05\0\x02\x03\0\0\x07context\x01B\x0e\x02\x03\x02\x01\x01\x04\0\x07\
context\x03\0\0\x01j\x01s\x01s\x01@\x01\x03ctx\x01\0\x02\x04\0\x06render\x01\x03\
\x01ps\x01k\x04\x01@\x01\x09selectors\x05\x01\0\x04\0\x08activate\x01\x06\x01o\x02\
ss\x01p\x07\x01j\0\x01s\x01@\x01\x09templates\x08\0\x09\x04\0\x09customize\x01\x0a\
\x03\0\"seed-keeper:wit-ui/wurbo-out@0.1.0\x05\x02\x01B\x13\x01r\x03\x04names\x07\
versions\x0bdescriptions\x04\0\x04page\x03\0\0\x01k\x01\x01ks\x01r\x02\x04page\x02\
...
\0\x0cnetworkevent\x01\x10\0\x04\0\x07context\x03\0\x11\x03\0!delano:wit-ui/cont\
ext-types@0.1.0\x05\x03\x02\x03\0\x02\x07context\x01B\x0e\x02\x03\x02\x01\x04\x04\
...
\x0a\x03\0\x1ddelano:wit-ui/wurbo-out@0.1.0\x05\x05\x02\x03\0\x01\x07context\x02\
...
\0\x07context\x03\0\x19\x03\0$peerpiper:wallet/context-types@0.1.0\x05\x08\x02\x03\
\0\x04\x0elisten-details\x01B\x08\x02\x03\x02\x01\x09\x04\0\x0elisten-details\x03\
\0\0\x01@\x01\x07details\x01\x01\0\x04\0\x10addeventlistener\x01\x02\x01@\x01\x07\
messages\x01\0\x04\0\x04emit\x01\x03\x01@\x01\x04hashs\x01\0\x04\0\x08set-hash\x01\
\x04\x03\0\x1fpeerpiper:wallet/wurbo-in@0.1.0\x05\x0a\x02\x03\0\x04\x07context\x01\
B\x0e\x02\x03\x02\x01\x0b\x04\0\x07context\x03\0\0\x01o\x02ss\x01p\x02\x01j\0\x01\
s\x01@\x01\x09templates\x03\0\x04\x04\0\x09customize\x01\x05\x01j\x01s\x01s\x01@\
\x01\x03ctx\x01\0\x06\x04\0\x06render\x01\x07\x01ps\x01k\x08\x01@\x01\x09selecto\
rs\x09\x01\0\x04\0\x08activate\x01\x0a\x04\0\x20peerpiper:wallet/wurbo-out@0.1.0\
\x05\x0c\x01B\x04\x01ps\x01k\0\x01@\x01\x09selectors\x01\x01\0\x04\0\x09activate\
s\x01\x02\x04\0\"peerpiper:wallet/aggregation@0.1.0\x05\x0d\x04\0\x20peerpiper:w\
allet/peerpiper@0.1.0\x04\0\x0b\x0f\x01\0\x09peerpiper\x03\0\0\0G\x09producers\x01\
